...
public class ElasticsearchConnectorConfig
{
    ...
    @ConfigDescription("Directory that contains JSON description files for Elasticsearch Index")
    ...
    @ConfigDescription("Set of tables known to this connector. For each table, a description file may be present in the catalog folder which describes columns for the given topic")
