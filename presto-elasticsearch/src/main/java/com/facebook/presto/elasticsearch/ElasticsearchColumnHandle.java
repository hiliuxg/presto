        ...
        implements ColumnHandle, Comparable<ElasticsearchColumnHandle>
{
    ...
    {
        this.column = new ElasticsearchColumnMetadata(requireNonNull(columnName, "columnName is null"), requireNonNull(columnType, "columnType is null"), requireNonNull(columnJsonPath, "columnJsonPath is null"), requireNonNull(columnJsonType, "columnJsonType is null"), isList, ordinalPosition);
    }
    ...
    public int hashCode()
    {
        return Objects.hash(column.getName(), column.getType(), column.getOrdinalPosition(), column.getJsonPath(), column.getJsonType(), column.isList());
    }
    ...
    @Override
    public int compareTo(ElasticsearchColumnHandle otherHandle)
    {
