        ...
        extends ColumnMetadata
{
    ...
    public boolean equals(Object o)
    {
        ...
        return jsonPath.equals(that.jsonPath) && jsonType.equals(that.jsonType) && ordinalPosition == that.ordinalPosition;
    }

    @Override
    public int hashCode()
    {
        return Objects.hash(jsonPath, jsonType, ordinalPosition);
    }
}
